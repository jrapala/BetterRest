...
//  BetterRest
//
//  Created by Juliette Rapala on 9/30/20.
//
...
struct ContentView: View {
    ...
    // static variable belong to the struct instead of a single instance of the struct
    ...
    func calculateBedtime() {
        ...
        do {
            // lets predict how much sleep you actually need (in seconds)
